  ...
  return (
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="w-full max-w-lg">
        ...
        <h2 className="text-xl font-bold text-foreground mb-1.5">Which course are we tackling today?</h2>
        <p className="text-muted text-sm mb-7 max-w-sm font-reading">
          Answers, quizzes, and flashcards — all pulled from your actual course materials.
        </p>
        <div className="grid grid-cols-2 gap-3">
          {subjects.map((subject) => (
            <button
              ...
              className="group flex items-center gap-3 rounded-xl border border-border bg-surface p-4 text-left hover:border-teal hover:bg-teal-soft hover:-translate-y-0.5 transition-all cursor-pointer"
            >
